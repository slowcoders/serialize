...
public class WeakValueMap<Key, Item> extends AbstractMap<Key, Item> {
	...
	static class Chain<T> extends WeakReference<T> {
		private final Object key;
		private final WeakValueMap map;

		Chain(WeakValueMap map, Object key, T value) {
