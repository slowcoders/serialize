...
//    }
    ...
    /**
     * Creates a new {@code JSONArray} with super from the given primitive array.
     */
    public JSONArray(Object array) throws JSONException {
        if (!array.getClass().isArray()) {
            super.addAll((Collection)array);
        }
        else {
    ...
    public JSONArray put(double value) throws JSONException {
        super.add(JSON.checkDouble(value));
        return this;
    }
...
//            throw new JSONException("Index " + index + " out of range [0.." + super.size() + ")");
//        }
//    }
    ...
    public JSONObject toJSONObject(JSONArray names) throws JSONException {
        ...
        int length = Math.min(names.length(), super.size());
        if (length == 0) {
            return null;
        }
        for (int i = 0; i < length; i++) {
