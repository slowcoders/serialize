...
public class JSONStringer {
    ...
    public static String getQuotedText(String value, char quote) {
    	StringBuilder out = new StringBuilder();
    	getQuotedText(out, value, quote);
    	return out.toString();
    }
    
    public static void getQuotedText(StringBuilder out, String value, char quote) {
        out.append(quote);
